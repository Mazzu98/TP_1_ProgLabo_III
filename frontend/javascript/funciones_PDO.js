...
function enviar() {
    ...
    if (AdministrarValidaciones()) {
        ...
        xhr_1.open('POST', "./../backend_PDO/administracion.php", true);
...
function AdministrarModificar(dni) {
    ...
    var ajax = new Ajax();
    ajax.Post('./alta_modif_PDO.php', ImprimirForm, 'dni=' + inputDni.value);
}
...
function cargarMostrar() {
    var ajax = new Ajax();
    ajax.Post("./../backend_PDO/mostrar.php", ImprimirMostrar);
}
